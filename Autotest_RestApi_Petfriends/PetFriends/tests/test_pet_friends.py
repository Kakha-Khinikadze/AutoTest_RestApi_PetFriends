...
def test_add_new_pet_without_photo_valid_data(name='Кот', animal_type='кот',
                                     age='5'):
...
def test_add_new_photo_valid_data(pet_photo='images/cat2.jpg'):
    ...
    # Добавляем питомца
    status, result = pf.add_new_photo(auth_key, pet_photo)
...
def test_add_new_photo_invalid_data(pet_photo=''):
    """Проверяем что можно добавить пустое значение вместо фото питомца"""
